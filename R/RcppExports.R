...
IndRePostDis <- function(re, data, rcpmeObj, scorevar, timevar, model, statutvar, gamma, link, age_of_diagnosis) {
    .Call('_rcpm_IndRePostDis', PACKAGE = 'rcpm', re, data, rcpmeObj, scorevar, timevar, model, statutvar, gamma, link, age_of_diagnosis)
}
